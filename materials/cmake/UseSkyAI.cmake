...
if(PROJECT_NAME STREQUAL SKYAI)
  ...
  find_path(MARKERDETECTION_edgeldetector_INCLUDE_DIR  NAMES edgeldetector.h PATH_SUFFIXES markerdetection  PATHS ${SKYAI_INSTALL_DIR}/include/skyai/3rdparty ${SKYAI_SOURCE_DIR}/3rdparty /usr/include/skyai/3rdparty /usr/local/include/skyai/3rdparty NO_DEFAULT_PATH)
  find_path(MARKERDETECTION_LIBRARY_DIR  NAMES libmarkerdetection.so PATH_SUFFIXES PATHS ${SKYAI_INSTALL_DIR}/lib/skyai ${SKYAI_BUILD_DIR}/3rdparty/markerdetection /usr/lib/skyai /usr/local/lib/skyai NO_DEFAULT_PATH)
  set (MARKERDETECTION_LIBRARIES markerdetection)
  ...
  find_path(LORA_common_INCLUDE_DIR  NAMES common.h PATH_SUFFIXES lora  PATHS ${SKYAI_INSTALL_DIR}/include/skyai ${SKYAI_SOURCE_DIR}/liblora/include /usr/include/skyai /usr/local/include/skyai NO_DEFAULT_PATH)
  find_path(LORA_LIBRARY_DIR  NAMES liblora_std.so PATH_SUFFIXES PATHS ${SKYAI_INSTALL_DIR}/lib/skyai ${SKYAI_BUILD_DIR}/liblora /usr/lib/skyai /usr/local/lib/skyai NO_DEFAULT_PATH)
  ...
  find_path(SKYAI_base_INCLUDE_DIR NAMES base.h PATH_SUFFIXES skyai PATHS ${SKYAI_INSTALL_DIR}/include/skyai ${SKYAI_SOURCE_DIR}/libskyai/include /usr/include/skyai /usr/local/include/skyai NO_DEFAULT_PATH)
  find_path(SKYAI_LIBRARY_DIR NAMES libskyai.so PATH_SUFFIXES PATHS ${SKYAI_INSTALL_DIR}/lib/skyai ${SKYAI_BUILD_DIR}/libskyai /usr/lib/skyai /usr/local/lib/skyai NO_DEFAULT_PATH)

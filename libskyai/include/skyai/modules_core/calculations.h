...
/*!\brief MBoolVectorNot: y = (!x[0], !x[1], ..., !x[N-1]); x: input (bool vector), y: output (bool vector)  */
FUNCTION_SISO_GEN (MBoolVectorNot, TBoolVector, TBoolVector)
//-------------------------------------------------------------------------------------------
...
/*!\brief MBoolNot: y = !x; x: input (bool), y: output (bool)  */
FUNCTION_SISO_GEN (MBoolNot, TBool, TBool)
//-------------------------------------------------------------------------------------------
